...
* **Grilling Completeness & 7 Pillars**: Ensure the requirements interview thoroughly covers all 7 data engineering pillars (Source format, Storage Medallion, Compute sizing, Orchestration, Data Quality & Quarantine, Consumption & PHI masking, and Observability/Alert routing) along with TerraShark failure mode protections (KMS CMK, S3 PAB, S3 Gateway Endpoints).
