...
Two tiers of data:
  core/pricing_data/aws_resource_map.json  — resource-type prefix -> serviceCode (+ display
      name, verification status). This is a REVIEWED, committed file, not invented at runtime.
  core/pricing_data/free_resources.json    — resource-type prefixes confirmed to carry no
