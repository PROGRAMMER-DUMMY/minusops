...
| :--- | :--- | :--- |
| [`__init__.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/__init__.py) | Package initialization | Module docstring defining generation & composition responsibilities |
| [`synthesizer.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/synthesizer.py) | Composition engine | Assembles modules + novel resources into root Terraform workspace; gating, context assembly, audit logging |
| [`modules.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py) | Module registry | Catalog metadata, keyword matching, preplan module derivation, grounding retrieval |
| [`module_provenance.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/module_provenance.py) | Module version pinning | Content hashing (`PROVENANCE.json`), versioning, upgrade reports, drift verification |
| [`blueprints.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/blueprints.py) | Blueprint registry | Schema validation and matching for demo/cached blueprint definitions |
| [`accelerators.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/accelerators.py) | Architecture accelerators | Pre-packaged reviewable requirement + decision templates (e.g. AWS Lakehouse) |
| [`intent_resolver.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/intent_resolver.py) | Intent classification | Maps natural language user requests to `REQUIREMENTS` or `OPERATION` intents |
| [`patterns.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/patterns.py) | Approved pattern store | Captures and matches previously approved module compositions (`.minus/patterns.json`) |
| [`workflow.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/workflow.py) | Request-to-run driver | Safe creation entry point: request -> run workspace -> `requirements.json` skeleton |
| [`terraform_generator.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/terraform_generator.py) | Demo HCL generator | Generates Terraform source for the `aws-data-pipeline-standard` demo fixture |
| [`demo.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/demo.py) | No-cloud demo runner | Standalone demo orchestrator creating run workspace, synthetic plan, and reports without AWS |
| [`schema_lint.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py) | G2 pre-write schema linter | Validates HCL attribute references, deprecations, types, and required fields against live provider schema |
| [`schema_watch.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py) | CI schema drift detector | Fetches live `terraform providers schema -json` and diffs against snapshot for deprecation/version changes |
...
### 1. [`__init__.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/__init__.py)
...
### 2. [`synthesizer.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/synthesizer.py)
...
* **Key Functions & Classes:**
  ...
  * **Promotion matrix (MINUS-114 / MINUS-130):** `_ENV_MATRIX`, `_render_env_tfvars(env, ...)`, `write_env_tfvars(out_dir, ...)`. Writes `envs/{dev,staging,prod}.tfvars` into the Terraform root; promotion is `terraform plan -var-file=envs/prod.tfvars` against the **same** root, never a forked `main.tf`. Only size, retention, and destroyability differ, so a prod plan is the same resource graph as the dev plan already reviewed.
    - **`force_destroy` is deliberately absent from the matrix.** `main.tf` derives it from `var.environment == "dev"`, so no var-file can enable it for prod. [`tests/test_promotion_matrix.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/tests/test_promotion_matrix.py) fails if it is ever added as a convenience.
  ...
  * `assemble_authoring_context(resource_type, justification, requirements_text, provider="aws")` ([L340-L376](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/synthesizer.py#L340-L376)): Assembles live schema, grounding examples, and knowledge claims for an authoring agent.
  * `remember_claim(...)` ([L267-L325](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/synthesizer.py#L267-L325)): Validates and persists researched claims into `knowledge_store` and JSONL corpus. Protects against prompt injections and fake price markers.
  * `_validate_novel_resources(decision, authored_content, ...)` ([L1009-L1170](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/synthesizer.py#L1009-L1170)): Fail-closed validator for authored resources using `schema_lint.gate_content()`.
  * `AuthoredContentRejected(ValueError)` ([L993-L1006](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/synthesizer.py#L993-L1006)): Exception carrying structured rejection reasons and G2 lint findings.
* **Inputs / Outputs:**
...
### 3. [`modules.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py)

* **Exact Purpose:** Catalog registry of small, composable Terraform modules stored under `modules/<id>/`.
* **Key Functions & Classes:**
  * `MODULES` ([L74-L222](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py#L74-L222)): Immutable list of catalog module definitions (ID, category, title, satisfies keywords, services, inputs, provides).
  * `match_modules(requirements, min_score=1)` ([L247-L273](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py#L247-L273)): Scores modules against free-text requirements based on keyword overlap with `satisfies` phrases.
  * `derive_module_ids(requirements_data)` ([L352-L419](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py#L352-L419)): Deterministically extracts module recommendations from explicit `data_pipeline` and `latency` fields in `requirements.json`.
  * `retrieve_grounding_examples(requirements, top_n=3)` ([L276-L308](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py#L276-L308)): Retrieves top-N module `main.tf` source code snippets as RAG grounding context for authoring agents.
  * `validate_modules()` ([L430-L448](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/modules.py#L430-L448)): Validates schema completeness and verifies on-disk existence of `modules/<id>/main.tf`.
* **Inputs / Outputs:**
...
### 4. [`module_provenance.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/module_provenance.py)

* **Exact Purpose:** Manages module catalog versioning, content hashing, and provenance tracking (`PROVENANCE.json`).
* **Key Functions & Classes:**
  * `content_hash(module_dir)` ([L65-L79](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/module_provenance.py#L65-L79)): Calculates deterministic SHA-256 hash over module directory contents (excluding `PROVENANCE.json`).
  * `pin(module_id, source, ...)` ([L102-L159](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/module_provenance.py#L102-L159)): Bumps version counter, records content hash, source, G2 findings, and writes upgrade reports into `upgrades/`.
  * `verify(module_id)` ([L162-L170](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/module_provenance.py#L162-L170)): Compares current content hash against recorded `PROVENANCE.json` to detect unpinned drift.
  * `show(module_id)` ([L86-L92](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/module_provenance.py#L86-L92)): Loads recorded `PROVENANCE.json` for a module.
* **Inputs / Outputs:**
...
### 5. [`blueprints.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/blueprints.py)

* **Exact Purpose:** Registry for product blueprints (specifically `aws-data-pipeline-standard` demo fixture).
* **Key Functions & Classes:**
  * `BLUEPRINTS` ([L32-L115](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/blueprints.py#L32-L115)): Registered blueprint metadata list.
  * `validate_blueprint(blueprint)` ([L122-L166](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/blueprints.py#L122-L166)) / `validate_blueprints()` ([L169-L182](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/blueprints.py#L169-L182)): Checks required blueprint fields, inputs, choices, and non-empty strings.
  * `match_blueprints(query, cloud=None)` ([L202-L238](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/blueprints.py#L202-L238)): Scores blueprints against natural language queries using alias and service matches.
* **Inputs / Outputs:**
...
### 6. [`accelerators.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/accelerators.py)
...
* **Key Functions & Classes:**
  * `lakehouse_requirements(owner=..., daily_data_gb=..., latency=...)` ([L44-L84](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/accelerators.py#L44-L84)): Generates pre-populated requirements record for an AWS Lakehouse.
  * `lakehouse_decision(requirements_file=..., streaming=..., daily_data_gb=...)` ([L87-L180](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/accelerators.py#L87-L180)): Generates architecture decision record, selecting scale-appropriate modules (compaction for TB, Iceberg for PB). Satisfies the TerraShark 4-part output contract (MINUS-136): it populates `validation` (validate + SEC scan + conformance + BCM evidence), `rollback` (hash-bound gate, `--destroy`, source-snapshot revert), and the `failure_modes` it designs against (`FM-01`, `FM-03`, `FM-05`) alongside `assumptions` and `alternatives`. Without these the accelerator's own output would no longer pass `architecture_decision.validate()`.
  * `write_lakehouse(run, ...)` ([L167-L188](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/accelerators.py#L167-L188)): Writes both records into a run workspace.
* **Inputs / Outputs:**
...
### 7. [`intent_resolver.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/intent_resolver.py)
...
* **Key Functions & Classes:**
  * `is_creation_request(query)` ([L73-L100](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/intent_resolver.py#L73-L100)): Classifies request by matching infrastructure terms and checking against interrogative ("what", "show") or operational ("deploy", "destroy") veto terms.
  * `resolve(query, cloud=None)` ([L110-L149](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/intent_resolver.py#L110-L149)): Maps creation queries to `REQUIREMENTS` intent and operational queries to `OPERATION`.
  * `format_resolution(result)` ([L152-L184](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/intent_resolver.py#L152-L184)): Formats resolution output for CLI display.
* **Inputs / Outputs:**
...
### 8. [`patterns.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/patterns.py)

* **Exact Purpose:** Persistence registry for approved, deployed architecture compositions (`.minus/patterns.json`).
* **Key Functions & Classes:**
  * `capture_pattern(requirements, module_ids, name=..., plan_hash=..., approver=...)` ([L45-L59](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/patterns.py#L45-L59)): Saves approved composition pattern.
  * `match_patterns(requirements, min_overlap=0.5)` ([L76-L88](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/patterns.py#L76-L88)): Calculates Jaccard similarity between candidate module sets and historical patterns to recommend proven compositions.
  * `load_patterns()` ([L25-L34](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/patterns.py#L25-L34)): Reads patterns from `.minus/patterns.json`.
* **Inputs / Outputs:**
...
### 9. [`workflow.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/workflow.py)

* **Exact Purpose:** Orchestrates the request-to-run workflow, creating run workspaces and seeding `requirements.json`.
* **Key Functions & Classes:**
  * `resolve_to_run(query, cloud=..., inputs=..., generate=False)` ([L54-L89](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/workflow.py#L54-L89)): Calls `intent_resolver.resolve()`, creates a run directory via `runs.py`, seeds `requirements.json` with the goal, and blocks direct generation.
  * `format_result(record)` ([L92-L121](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/workflow.py#L92-L121)): Prepares human-readable summary of the run creation status.
* **Inputs / Outputs:**
...
### 10. [`terraform_generator.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/terraform_generator.py)

* **Exact Purpose:** Generates static Terraform HCL files for the demo fixture blueprint (`aws-data-pipeline-standard`).
* **Key Functions & Classes:**
  * `generate(blueprint, inputs, terraform_dir)` ([L32-L36](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/terraform_generator.py#L32-L36)): Dispatcher validating blueprint ID.
  * `generate_aws_data_pipeline(inputs, terraform_dir)` ([L39-L395](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/terraform_generator.py#L39-L395)): Writes `main.tf`, `provider.tf`, `variables.tf`, `kms.tf`, `s3.tf`, `iam.tf`, `glue.tf`, `scripts.tf`, `step_functions.tf`, `athena.tf`, `monitoring.tf`, and `outputs.tf`. Also writes source guard baseline.
* **Inputs / Outputs:**
...
### 11. [`demo.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/demo.py)
...
* **Key Functions & Classes:**
  * `governed_data_pipeline(owner, daily_data_gb)` ([L100-L132](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/demo.py#L100-L132)): Runs `runs.new_run()`, calls `terraform_generator.generate()`, generates `synthetic_plan()`, and invokes `reporter.generate_from_plan_json()`.
  * `synthetic_plan(tf_dir, inputs)` ([L65-L97](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/demo.py#L65-L97)): Generates synthetic `terraform show -json` structure matching standard resource types.
* **Inputs / Outputs:**
...
### 12. [`schema_lint.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py)
...
* **Key Functions & Classes:**
  * `gate_content(content, source_label)` ([L398-L561](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py#L398-L561)): Core G2 linter. Parses top-level blocks, scans assigned attributes (`_scan_body`), extracts references (`extract_references`), and checks against live provider schema.
  * `gate_module(module_id)` ([L376-L395](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py#L376-L395)): Reads `modules/<module_id>/main.tf` and passes content to `gate_content()`.
  * `iter_hcl_blocks(content)` ([L69-L74](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py#L69-L74)): Yields top-level resource and data blocks using depth-aware brace matching (`_matching_brace`).
  * `_scan_body(body, prefix="")` ([L77-L138](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py#L77-L138)): Recursively scans block bodies for assigned attributes and flags unparseable `dynamic` blocks.
  * `_extract_assigned_values(body, prefix="")` ([L204-L249](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_lint.py#L204-L249)): Extracts assigned RHS text for literal shape inference (`_infer_literal_shape`).
* **Inputs / Outputs:**
...
### 13. [`schema_watch.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py)
...
* **Key Functions & Classes:**
  * `run_provider(provider, ...)` ([L260-L330](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py#L260-L330)): Fetches live schema, extracts types used by catalog modules (`used_types`), diffs against `schema-snapshot.json`, writes timestamped diff reports, and logs to `audit.jsonl`.
  * `get_type_schema(provider, type_name, kind="resource")` ([L139-L170](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py#L139-L170)): Returns raw schema block for a single resource/data source type.
  * `used_types(modules_dir, provider)` ([L76-L87](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py#L76-L87)): Scans `modules/*/main.tf` to identify active resource types.
  * `_fetch_schema(provider, workdir)` ([L90-L136](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py#L90-L136)): Runs `terraform init` and `terraform providers schema -json` in a temporary directory.
  * `_diff(old_snapshot, reduced, used_keys)` ([L204-L228](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/schema_watch.py#L204-L228)): Compares current reduced schema against previous snapshot.
* **Inputs / Outputs:**
...
### 14. [`knowledge_store.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py)

* **Exact Purpose:** Bi-temporal SQLite store and JSONL corpus for facts, claims, and agent adjudications (`claims.db` & `claims/*.jsonl`).
* **Key Functions & Classes:**
  * `init_db(path)` ([L57-L70](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py#L57-L70)): Creates SQLite tables (`claims`, `claim_adjudications`), indexes, and enables WAL mode.
  * `insert_claim(conn, ...)` ([L78-L107](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py#L78-L107)): Inserts a bi-temporal claim (`valid_from`, `observed_at`, `ingested_at`, `scope`, `content_hash`).
  * `invalidate_claim(conn, claim_id, *, valid_until, ...)` ([L141-L159](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py#L141-L159)): Marks a claim as invalidated by a newer claim.
  * `resolve(conn, resource_type, attribute=None)` ([L195-L281](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py#L195-L281)): Determines winning claim or `needs_review` status based on bi-temporal freshness clauses, string agreement, and delegated agent verdicts.
  * `export_jsonl(conn, root)` ([L326-L377](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py#L326-L377)) / `import_jsonl(conn, root)` ([L380-L438](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_store.py#L380-L438)): Serializes SQLite state to git-committable sharded JSONL files (`<type>.jsonl`, `_adjudications.jsonl`) and rebuilds cache.
* **Inputs / Outputs:**
...
### 15. [`knowledge_degradation.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_degradation.py)
...
* **Key Functions & Classes:**
  * `check_and_refresh(conn, provider, resource_type, kind="resource")` ([L27-L101](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_degradation.py#L27-L101)): Fetches fresh claims via `knowledge_diff.schema_claims_for_type()`, inserts new claims, invalidates old claims (`valid_until=valid_from`), and handles removed attributes.
* **Inputs / Outputs:**
...
### 16. [`knowledge_delegation.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_delegation.py)

* **Exact Purpose:** Manages agent-delegation hand-offs when `resolve()` encounters conflicting or `needs_review` claims.
* **Key Functions & Classes:**
  * `build_delegation_request(conn, resource_type, attribute)` ([L17-L39](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_delegation.py#L17-L39)): Packages conflicting claims into a structured hand-off payload for the driving agent.
  * `record_delegation_verdict(conn, resource_type, attribute, ...)` ([L42-L150](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_delegation.py#L42-L150)): Inserts agent verdict as a new `agent_delegated` claim and writes `claim_adjudications` linkage in a single transaction.
* **Inputs / Outputs:**
...
### 17. [`knowledge_diff.py`](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_diff.py)

* **Exact Purpose:** Converts live provider schema blocks into deterministic structural `schema` claim dictionaries.
* **Key Functions & Classes:**
  * `schema_claims_for_type(provider, resource_type, observed_at=None, kind="resource")` ([L18-L46](file:///C:/Users/shubh/PycharmProjects/MinusTeraformCli/core/generation/knowledge_diff.py#L18-L46)): Uses `schema_watch._fetch_schema()` to extract required/deprecated/optional flags per attribute and format claim dictionaries.
* **Inputs / Outputs:**
