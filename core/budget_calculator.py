...
core/bcm_pricing_calculator.py against the AWS BCM Pricing Calculator API (gated,
...
BCM_COMMANDS = [
    "python core/bcm_pricing_calculator.py prepare --report-dir <report-dir> --account-id <account-id>",
    "# review bcm-usage.json (resolve REVIEW_REQUIRED) or pass --usage-profile examples/bcm-usage-profile.example.json",
    "python core/bcm_pricing_calculator.py run --report-dir <report-dir> --mode gatekeeper",
]
