...
def owner_file_for_address(address, rtype):
    ...
    Composition-based synthesis (core/generation/synthesizer.py) puts every resource inside
    ...
    back to the legacy flat-file convention (core/generation/terraform_generator.py) for
