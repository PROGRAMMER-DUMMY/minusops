...
This document provides context for the top-level files in [`core`](./) and serves as an index linking to the detailed, file-by-file context indexes for every subpackage within `core/`.

---

## 1. Top-Level Core Files

- [`core/MAP.md`](./MAP.md): High-level architectural package map documenting the 6 subpackages of `core/`, cross-package dependencies, and stability expectations.
- [`core/__init__.py`](./__init__.py): Package initializer for the core governance and IaC synthesis engine.
...
1. **Governance**: [`core/governance/CONTEXT-governance.md`](./governance/CONTEXT-governance.md)  
...
2. **Generation & Synthesis**: [`core/generation/CONTEXT-generation.md`](./generation/CONTEXT-generation.md)  
...
3. **Architecture & Decisions**: [`core/architecture/CONTEXT-architecture.md`](./architecture/CONTEXT-architecture.md)  
...
4. **Cost & FinOps Evidence**: [`core/cost/CONTEXT-cost.md`](./cost/CONTEXT-cost.md)  
...
5. **Reporting & CLI**: [`core/reporting/CONTEXT-reporting.md`](./reporting/CONTEXT-reporting.md)  
...
7. **Provider Abstraction**: [`core/providers/CONTEXT-providers.md`](./providers/CONTEXT-providers.md)  
